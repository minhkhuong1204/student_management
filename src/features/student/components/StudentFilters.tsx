...
export function StudentFilters({ filter, cityList, onChange, onSearchChange }: StudentFiltersProps) {
    ...
    const handleSortChage =  (e: ChangeEvent<{name?: string; value: unknown}>) => {
        if (!onChange) return;
        ...
        <Box>
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6} lg={1}>
                    <Button fullWidth onClick={handleClearFilter}>Clear</Button>
                </Grid>
            </Grid>
        </Box>
    );
